...
# video pipeline converter by pranav ajay
...
def biaslayer_convert_fused(model):
    ...
    for name, module in model.named_children():
        if isinstance(module, torch.nn.LayerNorm):
            ...
            biaslayer_convert_fused(module)
...
class SD3Transformer2DModel():
    ...
    def __init__(
        ...
        self.transformer = biaslayer_convert_fused(self.transformer)
